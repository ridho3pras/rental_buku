...
<div class="mt-3 w-50">
    ...
    <form action="/book-edit/{{ $book->slug }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="book_code" id="code" class="form-control" placeholder="Book Code" required value="{{ $book->book_code }}">
        </div>
        <div class="mb-3">
            <label for="title" class="form-label">Book Title</label>
            <input type="text" name="title" id="title" class="form-control" placeholder="Book Title" required value="{{ $book->title }}">
        </div>
        ...
        <div class="mb-3">
            ...
            @else
                <img src="{{ asset('image/no-cover.jpg') }}" alt="" width="300px">
            @endif
        </div>
